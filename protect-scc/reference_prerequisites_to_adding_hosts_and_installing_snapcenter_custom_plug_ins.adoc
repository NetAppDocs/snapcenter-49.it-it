...
** Per gli host Windows, l'hash SHA512 si trova in
_C: File di programma/NetApp/SnapCenter Plug-in Creator.txt_ custom_plugin_checksum_list.txt_
+
...
+
https://imt.netapp.com/matrix/imt.jsp?components=112392;&solution=1259&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"]
