...
+
Opzionale: Puoi fare clic sull'image:../media/add_policy_from_resourcegroup.gif["aggiungi criterio dal gruppo di risorse"]icona per aggiungere più volumi, LUN e qtree da altri sistemi storage.
