...
. Selezionare i cloni, quindi fare clic image:../media/delete_icon.gif["elimina clone"] per eliminare i cloni o fare clic image:../media/split_cone.gif["clone split"] per suddividere i cloni.
. Fare clic su *OK*.
